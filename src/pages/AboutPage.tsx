...
export function AboutPage() {
  useSEO({
    title: "About Us | Karpathos Adventures Concierge",
    description: "Learn about Karpathos Adventures, a curated local marketplace and concierge service for the best tours, hikes, and experiences in Karpathos, Greece.",
    canonicalPath: "/about"
  });
  return (
